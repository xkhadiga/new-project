...
export default function AdBanner ({ 
  ...
  return (
    <AnimationOnScroll animateIn="animate__fadeIn" className={`w-full rounded-2xl shadow-md overflow-hidden flex flex-col-reverse md:flex-row items-center p-3 md:p-5 ${bgColor}`}>
